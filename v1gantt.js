...
#chart {
  ...
  #image-container {
    ...
    class XGanttChartWidget extends HTMLElement {
        constructor() {
            super();
        ...
        _updateData(dataBinding) {
            ...
            if (dataBinding && Array.isArray(dataBinding.data)) {
                console.log('  data:', dataBinding.data);
        ...
        _renderChart() {
            ...
            if (this._dhtmlxGanttReady) {
                ...
                gantt.config.taskListWidth = 450;
                gantt.config.editing.enable = false;
                //end tk
    ...
    customElements.define('xgantt-chart-widget', XGanttChartWidget);
})();